...
input_paths = {
	'csqa': {
		"extra_concepts": {
			"train": "./data/csqa/extra_concepts/train_concepts.pkl",
			"dev": "./data/csqa/extra_concepts/dev_concepts.pkl",
			"test": "./data/csqa/extra_concepts/test_concepts.pkl",
		},
	...
	'obqa': {
		"extra_concepts": {
			"train": "./data/obqa/extra_concepts/train_concepts.pkl",
			"dev": "./data/obqa/extra_concepts/dev_concepts.pkl",
			"test": "./data/obqa/extra_concepts/test_concepts.pkl",
		},
...
def main():
	...
	parser.add_argument('--run', default=['obqa'], choices=['common', 'csqa', 'hswag', 'anli', 'exp', 'scitail', 'phys', 'socialiqa', 'obqa', 'make_word_vocab'], nargs='+')
	...
	routines = {
		...
		'csqa': [
			...
			# 						  output_paths['cpnet']['patterns'], output_paths['csqa']['grounded']['train'], input_paths["csqa"]["extra_concepts"]["train"], args.nprocs)},
			# {'func': ground, 'args': (output_paths['csqa']['statement']['dev'], output_paths['cpnet']['vocab'],
			# 						  output_paths['cpnet']['patterns'], output_paths['csqa']['grounded']['dev'], input_paths["csqa"]["extra_concepts"]["dev"], args.nprocs)},
			# {'func': ground, 'args': (output_paths['csqa']['statement']['test'], output_paths['cpnet']['vocab'],
			# 						  output_paths['cpnet']['patterns'], output_paths['csqa']['grounded']['test'], input_paths["csqa"]["extra_concepts"]["test"], args.nprocs)},
		...
		'obqa': [
			...
			# 						  output_paths['cpnet']['patterns'], output_paths['obqa']['grounded']['train'], input_paths["obqa"]["extra_concepts"]["train"], args.nprocs)},
			# {'func': ground, 'args': (output_paths['obqa']['statement']['dev'], output_paths['cpnet']['vocab'],
			# 						  output_paths['cpnet']['patterns'], output_paths['obqa']['grounded']['dev'], input_paths["obqa"]["extra_concepts"]["dev"], args.nprocs)},
			# {'func': ground, 'args': (output_paths['obqa']['statement']['test'], output_paths['cpnet']['vocab'],
			# 						  output_paths['cpnet']['patterns'], output_paths['obqa']['grounded']['test'], input_paths["obqa"]["extra_concepts"]["test"], args.nprocs)},
